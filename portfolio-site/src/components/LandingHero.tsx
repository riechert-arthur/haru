...
export default function LandingHero() {
  ...
  return (
    <div className="lg:max-w-large-screens flex flex-col items-center w-full dark:text-white text-black">
      <div
        className={`flex flex-col mb-8 lg:mb-0 md:flex-row w-full md:justify-between
                items-center font-mono text-sm tracking-wider`}
      >
        <div className="flex flex-col w-full justify-center items-center">
          <h1 className="w-full text-5xl md:text-5xl text-center md:text-left">
            Software Engineer
          </h1>
          <Image
            src="/head_shot.jpeg"
          ...
          <div className="flex max-w-4xl">
            <p className="lg:mt-7 mt-14 text-2xl text-center md:text-left leading-8 tracking-widest leading-relaxed">
              Hi, my name is Arthur. I am a computer science student and
              aspiring software engineer from Georgia Institute of Technology.
            </p>
          </div>
        </div>
        <Image
