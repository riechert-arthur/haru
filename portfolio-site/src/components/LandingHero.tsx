...
export default function LandingHero() {
    return (
        <div className="flex z-10 w-full justify-between font-mono text-sm tracking-wider">
            <div>
                ...
                <button className={`p-6 mt-14 bg-sky-500/80 rounded-2xl ${montserrat.className} font-bold text-3xl`}>Learn More</button>
            </div>
