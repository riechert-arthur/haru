...
const socials: SocialLink[] = [
  {
    name: "Twitter",
    icon: "/twitter.svg",
    url: "https://twitter.com/ArtieRiechert",
  },
  {
    name: "Github",
    icon: "/github-sign.svg",
    url: "https://github.com/riechert-arthur",
  },
  {
    name: "Linkedin",
    icon: "/linkedin.svg",
    url: "https://www.linkedin.com/in/arthur-riechert-4b1414224/",
  },
]
  ...
  return (
    <footer className="flex flex-col overflow-x-hidden md:-mt-60 w-full text-white">
      ...
      <div className="flex flex-col p-2 w-full items-center py-2 bg-sky-400">
        ...
        <div
          className={`flex flex-wrap justify-center md:flex-row mt-1 md:mt-3 md:justify-between
        ...
        >
          {internalLinks.map((link: InternalLink, index: number) => (
            <Link className="mr-4 md:mr-0" href={link.route} key={index}>
              {link.name}
            </Link>
          ))}
        </div>
